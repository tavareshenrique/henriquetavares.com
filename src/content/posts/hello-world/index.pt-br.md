...
## Menção Honrosa
---
Este site está em [Astro](https://astro.build/) com [Tailwind CSS](https://tailwindcss.com/), mantendo o fluxo editorial que nasceu a partir de um starter no estilo [Gatsby blog](https://github.com/gatsbyjs/gatsby-starter-blog). Tema de sintaxe baseado no [Night Owl da Sarah Drasner](https://github.com/sdras/night-owl-vscode-theme/) com alguns pequenos ajustes meus.
